function drawChess() {
    ...
    let figure = {
        0 : ['-263px -19px', '-484px -22px', '-372px -17px', '-150px -16px', '-42px -17px','-372px -17px', '-484px -22px','-263px -19px'],
        ...
        7 : ['-263px -116px', '-484px -116px', '-372px -116px', '-152px -113px', '-40px -114px','-372px -116px', '-484px -116px','-263px -116px'],
    };
